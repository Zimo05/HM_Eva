...
class TPPDataset(Dataset):
    def __init__(self, data: Dict):
        ...
        self.optional_masks = {
            ...
            for name in ('event_loss_mask', 'type_loss_mask', 'time_loss_mask')
    ...
    def __getitem__(self, idx):
        ...
        """
        item = dict({'time_seqs': self.time_seqs[idx], 'time_delta_seqs': self.time_delta_seqs[idx],
                     'type_seqs': self.type_seqs[idx]})
        for name, values in self.optional_masks.items():
